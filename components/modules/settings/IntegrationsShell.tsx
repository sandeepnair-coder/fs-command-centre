...
const SETUP_INSTRUCTIONS: Record<ChannelProvider, {
  ...
  whatsapp: {
    ...
    steps: [
      "WhatsApp uses the existing OpenClaw gateway",
      "Enter the business phone number that OpenClaw is connected to",
      "Messages will flow through OpenClaw automatically",
    ],
    consoleUrl: "",
    consoleName: "",
  },
