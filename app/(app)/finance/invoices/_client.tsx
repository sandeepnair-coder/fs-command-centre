...
export function InvoicesClient({ initialInvoices, initialProjects }: { initialInvoices: Invoice[]; initialProjects: { id: string; title: string; cost: number | null; client_name: string | null }[] }) {
